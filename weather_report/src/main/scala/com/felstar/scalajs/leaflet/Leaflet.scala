...
object L extends js.Object {
  ...
  def imageOverlay(imageUrl: String, bounds: LatLngBounds, options: ImageOverlayOptions= ???): ImageOverlay = js.native
  def marker(latLng: LatLng, markerOptions: MarkerOptions= ??? ): Marker = js.native
  def circle(latLng: LatLng, options: CircleOptions= ???):Circle = js.native
  def circleMarker(latLng: LatLng, options: CircleMarkerOptions= ???):CircleMarker = js.native
  def polygon(latLngs: LatLngArray, options: PolylineOptions= ??? ):Polygon = js.native
  def polyline(latLngs: LatLngArray, options: PolylineOptions= ??? ):Polyline = js.native
  def rectangle(latLngs: LatLngBounds, options: PolylineOptions= ??? ):Rectangle = js.native
  ...
  def tooltip(options: TooltipOptions= ???, source: Layer= ???): Point = js.native
  def layerGroup(layers: js.Array[Layer]= ???): LayerGroup = js.native
  def featureGroup(layers: js.Array[Layer]= ???): FeatureGroup = js.native
  def geoJSON(geojson: js.Object = ???, options:GeoJSONOptions= ???): GeoJSON = js.native
  def icon(options: IconOptions= ???):Icon = js.native
  @js.native
  object control extends js.Object{
    def layers(baseLayers: js.Object= ???, overLays: js.Object= ???, options: ControlLayerOptions= ???):ControlLayer = js.native
...
class ControlLayerOptionBuilder(val dict:OptMap) extends SCOptionBuilder[ControlLayerOptions, ControlLayerOptionBuilder](new ControlLayerOptionBuilder(_))
  with ControlLayerSetters[ControlLayerOptions,ControlLayerOptionBuilder]

trait ControlLayerSetters[T <: js.Object, B <: SCOptionBuilder[T,_]] extends SCOptionSetter[T, B] {
...
class ControlScaleOptionBuilder(val dict:OptMap) extends SCOptionBuilder[ControlScaleOptions, ControlScaleOptionBuilder](new ControlScaleOptionBuilder(_))
  with ControlScaleSetters[ControlScaleOptions,ControlScaleOptionBuilder]

trait ControlScaleSetters[T <: js.Object, B <: SCOptionBuilder[T,_]] extends SCOptionSetter[T, B] {
...
trait Evented extends js.Object {
  ...
  def fire(event:String, data: js.Any= ???, propagate: Boolean= ???):this.type = js.native
...
trait LMap extends js.Object with Evented{
  ...
  def eachLayer(fn:js.Function, context:js.Any=literal()):Boolean = js.native

  def setView(center:LatLng, zoom:Int, options: ZoomPanOptions = ???):this.type = js.native
  ...
  def setZoomAround(latLng:LatLng, zoom:Int, options: ZoomOptions= ???):this.type = js.native
  //def setZoomAround(offset:Point, zoom:Int, options: ZoomOptions= ???):this.type = js.native
  def fitBounds(bounds:LatLngBounds, options: FitBoundsOptions= ???):this.type = js.native
  ...
  def flyTo(latLng: LatLng, zoom: Int, options: ZoomPanOptions= ???):this.type = js.native
  def flyToBounds(bounds: LatLngBounds, options: FitBoundsOptions= ???):this.type = js.native
  ...
  def panInsideBounds(bounds: LatLngBounds, options: PanOptions= ???):this.type = js.native
  ...
  def getBoundsZoom(bounds: LatLngBounds, inside: Boolean= ???):Int = js.native
  ...
  def mouseEventToContainerPoint(mouseEvent: LeafletMouseEvent):Point = js.native
...
class ZoomPanOptionBuilder(val dict:OptMap) extends SCOptionBuilder[ZoomPanOptions, ZoomPanOptionBuilder](new ZoomPanOptionBuilder(_))
  with ZoomPanSetters[ZoomPanOptions,ZoomPanOptionBuilder]

trait ZoomPanSetters[T <: js.Object, B <: SCOptionBuilder[T,_]] extends SCOptionSetter[T, B] {
...
class FitBoundsOptionBuilder(val dict:OptMap) extends SCOptionBuilder[FitBoundsOptions, FitBoundsOptionBuilder](new FitBoundsOptionBuilder(_))
  with FitBoundsSetters[FitBoundsOptions, FitBoundsOptionBuilder]
  with ZoomPanSetters[FitBoundsOptions,FitBoundsOptionBuilder]

trait FitBoundsSetters[T <: js.Object, B <: SCOptionBuilder[T,_]] extends SCOptionSetter[T, B] {
...
class ZoomOptionBuilder(val dict:OptMap) extends SCOptionBuilder[ZoomOptions, ZoomOptionBuilder](new ZoomOptionBuilder(_))
  with ZoomSetters[ZoomOptions,ZoomOptionBuilder]

trait ZoomSetters[T <: js.Object, B <: SCOptionBuilder[T,_]] extends SCOptionSetter[T, B] {
  def animate(v:Boolean)= jsOpt(v)
}
...
class PanOptionBuilder(val dict:OptMap) extends SCOptionBuilder[PanOptions, PanOptionBuilder](new PanOptionBuilder(_))
  with PanSetters[PanOptions, PanOptionBuilder]

trait PanSetters[T <: js.Object, B <: SCOptionBuilder[T,_]] extends SCOptionSetter[T, B] {
  def animate(v:Boolean)= jsOpt(v)
  def duration(v:Double)= jsOpt(v)
  def easeLinearity(v:Double)= jsOpt(v)
  def noMoveStart(v:Boolean)= jsOpt(v)
...
class LMapOptionBuilder(val dict:OptMap) extends SCOptionBuilder[LMapOptions, LMapOptionBuilder](new LMapOptionBuilder(_)) {
...
trait Layer extends js.Object with Evented{
  ...
  def bindTooltip(html:String, tooltipOptions:TooltipOptions= ???):this.type = js.native
  def unbindTooltip():this.type = js.native
  def openTooltip(tooltip: Tooltip):this.type = js.native
  def openTooltip(latlng: LatLng, options:TooltipOptions= ???):this.type = js.native
...
class GeoJSONOptionBuilder(val dict:OptMap) extends SCOptionBuilder[GeoJSONOptions, GeoJSONOptionBuilder](new GeoJSONOptionBuilder(_))
  with GeoJSONSetters[GeoJSONOptions, GeoJSONOptionBuilder]

trait GeoJSONSetters[T <: js.Object, B <: SCOptionBuilder[T,_]] extends SCOptionSetter[T, B] {
...
class ImageOverlayOptionBuilder(val dict:OptMap) extends SCOptionBuilder[ImageOverlayOptions, ImageOverlayOptionBuilder](new ImageOverlayOptionBuilder(_))
  with ImageOverlaySetters[ImageOverlayOptions, ImageOverlayOptionBuilder]

trait ImageOverlaySetters[T <: js.Object, B <: SCOptionBuilder[T,_]] extends SCOptionSetter[T, B] {
...
class TileLayerOptionBuilder(val dict:OptMap) extends SCOptionBuilder[TileLayerOptions, TileLayerOptionBuilder](new TileLayerOptionBuilder(_))
...
trait TileLayerSetters[T <: js.Object, B <: SCOptionBuilder[T,_]] extends SCOptionSetter[T, B] {
...
trait GridLayerSetters[T <: js.Object, B <: SCOptionBuilder[T,_]] extends SCOptionSetter[T, B] {
  //def icon(v:Boolean)= jsOpt("animate",v)
...
class MarkerOptionBuilder(val dict:OptMap) extends SCOptionBuilder[MarkerOptions, MarkerOptionBuilder](new MarkerOptionBuilder(_))
  with MarkerSetters[MarkerOptions, MarkerOptionBuilder]

trait MarkerSetters[T <: js.Object, B <: SCOptionBuilder[T,_]] extends SCOptionSetter[T, B] {
...
class IconOptionBuilder(val dict:OptMap) extends SCOptionBuilder[IconOptions, IconOptionBuilder](new IconOptionBuilder(_))
  with IconSetters[IconOptions, IconOptionBuilder]

trait IconSetters[T <: js.Object, B <: SCOptionBuilder[T,_]] extends SCOptionSetter[T, B] {
...
class PathOptionBuilder(val dict:OptMap) extends SCOptionBuilder[PathOptions, PathOptionBuilder](new PathOptionBuilder(_))
  with PathSetters[PathOptions, PathOptionBuilder]

trait PathSetters[T <: js.Object, B <: SCOptionBuilder[T,_]] extends SCOptionSetter[T, B] {
  //def icon(v:Boolean)= jsOpt("animate",v)
...
class PolylineOptionBuilder(val dict:OptMap) extends SCOptionBuilder[PolylineOptions, PolylineOptionBuilder](new PolylineOptionBuilder(_))
  with PathSetters[PolylineOptions, PolylineOptionBuilder]
  with PolylineSetters[PolylineOptions, PolylineOptionBuilder]

trait PolylineSetters[T <: js.Object, B <: SCOptionBuilder[T,_]] extends SCOptionSetter[T, B] {
...
class CircleMarkerOptionBuilder(val dict:OptMap) extends SCOptionBuilder[CircleMarkerOptions, CircleMarkerOptionBuilder](new CircleMarkerOptionBuilder(_))
...
trait CircleMarkerSetters[T <: js.Object, B <: SCOptionBuilder[T,_]] extends SCOptionSetter[T, B] {
  //def icon(v:Boolean)= jsOpt("animate",v)
...
class CircleOptionBuilder(val dict:OptMap) extends SCOptionBuilder[CircleOptions, CircleOptionBuilder](new CircleOptionBuilder(_))
  with PathSetters[CircleOptions, CircleOptionBuilder]
  with CircleSetters[CircleOptions, CircleOptionBuilder]

trait CircleSetters[T <: js.Object, B <: SCOptionBuilder[T,_]] extends SCOptionSetter[T, B] {
  //def icon(v:Boolean)= jsOpt("animate",v)
  def radius(v:Int)= jsOpt(v)
}
...
class PopupOptionBuilder(val dict:OptMap) extends SCOptionBuilder[PopupOptions, PopupOptionBuilder](new PopupOptionBuilder(_))
  with PopupSetters[PopupOptions, PopupOptionBuilder]
  with DivOverlaySetters[PopupOptions, PopupOptionBuilder]

trait PopupSetters[T <: js.Object, B <: SCOptionBuilder[T,_]] extends SCOptionSetter[T, B] {
  def maxWidth(v:Int)= jsOpt(v)
...
trait DivOverlaySetters[T <: js.Object, B <: SCOptionBuilder[T,_]] extends SCOptionSetter[T, B] {
...
class TooltipOptionBuilder(val dict:OptMap) extends SCOptionBuilder[TooltipOptions, TooltipOptionBuilder](new TooltipOptionBuilder(_))
  with TooltipSetters[TooltipOptions, TooltipOptionBuilder]
  with DivOverlaySetters[TooltipOptions, TooltipOptionBuilder]

trait TooltipSetters[T <: js.Object, B <: SCOptionBuilder[T,_]] extends SCOptionSetter[T, B] {
...
object LMapEvent extends Enumeration {
  ...
  val zoomlevelschange, resize, unload, viewreset, load, zoomstart,
  zoom, move, zoomend,
  popupopen, popupclose, autopanstart,
  tooltipopen, tooltipclose, locationerror, locationfound,
  click,dblclick, mousedown , mouseup , mouseover , mouseout , mousemove ,
  contextmenu,keypress , preclick,
  dragstart, movestart, drag, dragend, moveend,
  loading, tileunload, tileloadstart, tilerror, tileload,
  add, remove,
  zoomanim = Value
}
